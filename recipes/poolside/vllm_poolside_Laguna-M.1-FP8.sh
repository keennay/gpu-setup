...
EXTRA_ARGS="--dtype bfloat16 --kv-cache-dtype fp8_e4m3 --default-chat-template-kwargs {\"enable_thinking\":true}"

RECIPE_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd -P)"
source "$RECIPE_DIR/../../tools/recipes/inference_recipe.sh"

BACKEND_ATTENTION_SM90=""
BACKEND_FP8_GEMM_SM90="--linear-backend triton"
BACKEND_FP4_GEMM_SM90="--linear-backend triton"
BACKEND_MOE_RUNNER_SM90=""
CONTEXT_LEN_VALUE_SM90=262144
GPU_MEM_UTIL_VALUE_SM90=0.859321
