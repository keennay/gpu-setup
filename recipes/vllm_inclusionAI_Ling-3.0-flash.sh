...
INFERENCE_ENV=""
MODEL_REPO="inclusionAI/Ling-3.0-flash"
MODEL_NAME="ling3"
...
EXTRA_ARGS="--dtype bfloat16 --enable-chunked-prefill --compilation-config {\"cudagraph_mode\":\"FULL_AND_PIECEWISE\"} --enable-prefix-caching --mamba-cache-mode align"
