...
INFERENCE_ENV=""
MODEL_REPO="RedHatAI/gemma-4-26B-A4B-it-NVFP4"
MODEL_NAME="gemma4"
...
EXTRA_ARGS="--reasoning-parser gemma4 --limit-mm-per-prompt {\"image\":4} --async-scheduling"
