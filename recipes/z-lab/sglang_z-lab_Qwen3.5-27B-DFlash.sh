...
SPECULATIVE="--speculative-algorithm DFLASH --speculative-draft-model-path z-lab/Qwen3.5-27B-DFlash --speculative-dflash-block-size 8 --speculative-draft-attention-backend fa4"
QUANTIZATION=""
