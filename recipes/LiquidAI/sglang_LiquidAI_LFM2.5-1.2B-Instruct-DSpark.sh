...
SPECULATIVE="--speculative-algorithm DSPARK --speculative-draft-model-path LiquidAI/LFM2.5-1.2B-Instruct-DSpark --speculative-draft-attention-backend flashinfer"
QUANTIZATION=""
NO_PREFIX_CACHE=""
SCRIPT_DIR=""
