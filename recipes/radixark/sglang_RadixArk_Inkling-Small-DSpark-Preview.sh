...
SPECULATIVE="--speculative-algorithm DSPARK --speculative-draft-model-path RadixArk/Inkling-Small-DSpark-Preview --speculative-draft-model-quantization unquant --speculative-dspark-block-size 7"
