...
EXTRA_ARGS="--enable-flashinfer-allreduce-fusion --mamba-ssm-dtype bfloat16 --mamba-radix-cache-strategy extra_buffer --max-running-requests 128 --chunked-prefill-size 16384"
...
GPU_MEM_UTIL_VALUE_SM90=0.803667
