...
INFERENCE_ENV=""
MODEL_REPO="inclusionAI/Ling-3.0-flash-int4"
MODEL_NAME="ling3"
...
SPECULATIVE="--speculative-algorithm DSPARK --speculative-draft-model-path inclusionAI/Ling-3.0-flash-dspark --enable-linear-replayssm-spec --linear-replayssm-cache-len 32"
QUANTIZATION=""
