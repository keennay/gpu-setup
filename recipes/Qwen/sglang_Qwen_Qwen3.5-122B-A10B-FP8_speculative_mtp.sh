...
EXTRA_ARGS="--enable-flashinfer-allreduce-fusion --attention-backend flashinfer --mamba-ssm-dtype bfloat16 --mamba-radix-cache-strategy extra_buffer --max-running-requests 128 --chunked-prefill-size 16384"
