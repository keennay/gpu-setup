...
INFERENCE_ENV=""
MODEL_REPO="RedHatAI/gemma-4-12B-it-FP8-Dynamic"
MODEL_NAME="gemma4"
...
EXTRA_ARGS="--reasoning-parser gemma4 --kv-cache-dtype fp8 --limit-mm-per-prompt {\"image\":4,\"audio\":1} --async-scheduling"
