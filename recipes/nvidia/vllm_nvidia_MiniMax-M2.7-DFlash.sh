...
SERVED_MODEL_NAME="nvidia/MiniMax-M2.7-DFlash"
...
SPECULATIVE="--speculative-config {\"method\":\"dflash\",\"model\":\"nvidia/MiniMax-M2.7-DFlash\",\"num_speculative_tokens\":8}"
QUANTIZATION=""
NO_PREFIX_CACHE=""
