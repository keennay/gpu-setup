...
EXTRA_ARGS="--enable-expert-parallel --kv-cache-dtype fp8 --block-size 256 --tokenizer-mode deepseek_v4 --max-num-seqs 16 --max-num-batched-tokens 16384 --enforce-eager"
...
GPU_MEM_UTIL_VALUE_SM90=0.864600
