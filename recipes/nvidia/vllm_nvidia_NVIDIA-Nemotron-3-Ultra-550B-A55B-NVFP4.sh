...
EXTRA_ARGS="--dtype bfloat16 --kv-cache-dtype fp8 --max-num-seqs 16 --max-num-batched-tokens 32768 --enable-chunked-prefill --enable-prefix-caching --mamba-backend triton --mamba-ssm-cache-dtype float32"
