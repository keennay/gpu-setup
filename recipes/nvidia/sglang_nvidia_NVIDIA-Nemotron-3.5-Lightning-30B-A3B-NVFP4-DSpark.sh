...
SPECULATIVE="--speculative-algorithm DSPARK --speculative-draft-model-path nvidia/NVIDIA-Nemotron-3.5-Lightning-30B-A3B-NVFP4-DSpark --speculative-dspark-block-size 3"
QUANTIZATION=""
