...
SPECULATIVE='--speculative_config.method dflash --speculative_config.model nvidia/NVIDIA-Nemotron-3.5-Lightning-30B-A3B-NVFP4-DFlash --speculative_config.num_speculative_tokens 3'
QUANTIZATION=""
