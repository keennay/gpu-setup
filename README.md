...
A quick & simple way to stage an Ubuntu / RHEL NVIDIA node for ML workloads, including building & serving inference cookbook recipes for Large Language Models & Visual-Language Models. Use on your own bare-metal / VM server or rental cloud provider (Verda, Massed Compute, Prime Intellect, etc).
